...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      { title: "Contact — Electronic Hive" },
      { name: "description", content: "Reach Electronic Hive in Accra, Ghana. WhatsApp or call — we reply within minutes." },
    ],
  }),
});
        ...
        <div className="space-y-4">
          <a href={whatsappLink()} target="_blank" rel="noopener" className="flex items-center gap-4 p-5 rounded-xl border border-border bg-card hover:shadow-[var(--shadow-elegant)] transition-all">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Tap to chat — reply within minutes</p>
            </div>
          </a>
          ...
          <div className="flex items-center gap-4 p-5 rounded-xl border border-border bg-card">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">We reply within minutes</p>
            </div>
          </div>
        </div>
